...
- Integrated dev-env - modpack testing, configs, scripts & java-patches are all run in the same place. No more fragmented dev-envs.

Tl;DR : Modpack development using this tool is about as easy as regular mod development. Which, in my opinion, is a **significant upgrade** from the current tools that exist... in context of the current neglection for easy modpack development.

Use this project to your desire!

_**Credits**_

- Possible Triangle : This could **not** have been possible without the awesome _Possible Triangle's Packwiz Gradle Plugin_