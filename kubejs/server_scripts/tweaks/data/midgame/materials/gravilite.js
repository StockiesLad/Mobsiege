recipes((event, funcs) => {
     ...
     funcs.generate('5x edenring:gravilite_shards', ['edenring:gravilite_shards', '#minecraft:prismarine_shard']).rollingSquare(1, 3).override(['reliquary:alkahestry_tome', 4]).next().toolDamaging()
})