recipes((event, funcs) => {
     ...
     event.recipes.thermal.crucible(ofFluid('embers:molten_bronze', 90), preferredItemId('forge:ingots/bronze'))
     event.recipes.thermal.crucible(ofFluid('embers:molten_bronze', 90), preferredItemId('forge:dusts/bronze'))
