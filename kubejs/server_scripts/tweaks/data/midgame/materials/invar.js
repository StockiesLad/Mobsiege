recipes((event, funcs) => {
     ...
     event.recipes.thermal.crucible(ofFluid('embers:molten_invar', 90), preferredItemId('forge:ingots/invar'))
     event.recipes.thermal.crucible(ofFluid('embers:molten_invar', 90), preferredItemId('forge:dusts/invar'))
