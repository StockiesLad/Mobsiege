commonTags((event, funcs) => {
    event.add(comfuncs.packDef('sleeping_blocks'), ['#minecraft:beds', '#comforts:sleeping_bags', '#comforts:hammocks', '#upgrade_aquatic:bedrolls', '#valhelsia_structures:sleeping_bags'])
})
