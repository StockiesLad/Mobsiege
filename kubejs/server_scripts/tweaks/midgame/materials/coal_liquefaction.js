recipes((event, funcs) => {
     ...
     funcs.globalLiquefaction(ofFluid('thermal:creosote', 25), Item.of('supplementaries:ash').withCount(3), custom.poor_grade_charcoal)
     funcs.globalLiquefaction(ofFluid('thermal:creosote', 100), Item.of('supplementaries:ash').withCount(2), custom.low_grade_charcoal)
     funcs.globalLiquefaction(ofFluid('thermal:creosote', 150), Item.of('supplementaries:ash').withCount(2), custom.medium_grade_charcoal)
