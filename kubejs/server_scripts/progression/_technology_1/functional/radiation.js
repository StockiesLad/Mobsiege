recipes((event, funcs) => {
     ...
     funcs.vanillaInsert(funcs.removeByOutput('hardcore_torches:fire_starter'), [['#notreepunching:string', 0], [dataTag + 'rods/wooden', [1, 2]]])
     ...
     funcs.vanillaInsert('4x minecraft:torch', [['minecraft:blaze_powder', 0], [tags.medium_grade_coal, 3], [dataTag + 'rods/wooden', 6]])

     funcs.toolDamagingShapeless(funcs.removeInsurely({input: 'minecraft:stick', output: '8x hardcore_torches:unlit_torch'}), [tags.high_grade_coal, 'primalstage:spruce_logs', '#minecraft:saws'])
     funcs.toolDamagingShapeless('4x hardcore_torches:unlit_torch', [tags.good_grade_coal, 'primalstage:spruce_logs', '#minecraft:saws'])
     funcs.vanillaInsert(funcs.removeByOutput('2x hardcore_torches:unlit_torch'), [[tags.medium_grade_coal, 0], [dataTag + 'rods/wooden', 2]])
     funcs.toolDamagingShapeless('hardcore_torches:unlit_torch', [tags.low_grade_coal, 'primalstage:spruce_logs', '#minecraft:saws'])

     event.shapeless('hardcore_torches:unlit_torch', [tags.poor_grade_coal, 'hardcore_torches:burnt_torch'])
     event.shapeless('2x hardcore_torches:unlit_torch', [tags.low_grade_coal, Item.of('hardcore_torches:burnt_torch').withCount(2)])
     event.shapeless('4x hardcore_torches:unlit_torch', [tags.medium_grade_coal, Item.of('hardcore_torches:burnt_torch').withCount(4)])
     event.shapeless('6x hardcore_torches:unlit_torch', [tags.good_grade_coal, Item.of('hardcore_torches:burnt_torch').withCount(6)])
     event.shapeless('8x hardcore_torches:unlit_torch', [tags.high_grade_coal, Item.of('hardcore_torches:burnt_torch').withCount(8)])
})
...
blockTags((event, funcs) => {
     ...
     funcs.add('minecraft:wall_post_override', ['hardcore_torches:smoldering_torch', 'hardcore_torches:lit_torch'])
          .add('hardcore_torches:free_torch_light_blocks', dataTag + 'campfires')
          .add('toughasnails:cooling_blocks', cooling)
          .add('toughasnails:heating_blocks', heating)
          .add('primalstage:lit_blocks', [dataTag + 'campfires', 'minecraft:soul_campfire'])
})
