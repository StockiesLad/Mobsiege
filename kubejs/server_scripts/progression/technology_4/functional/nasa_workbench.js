recipes((event, funcs) => {
     funcs.replaceWithInsert('ad_astra:nasa_workbench', [
          ['create:large_cogwheel', 12], 
          [`#${main}:ingots/rose_gold`, 17], 
          ...
          [`#${main}:ingots/redstone_alloy`, [1, 3, 5, 9, 15, 19, 21, 23]], 
          ['thermal:machine_frame', [0, 4, 20, 24]]
     ]).mechanical()

     funcs.replaceWithInsert('ad_astra_giselle_addon:automation_nasa_workbench', [
          ['ad_astra:nasa_workbench', 4],
          [`#${main}:ingots/constantan`, [3, 5]],
          ['ae2:engineering_processor', 1],
          ['enderio:z_logic_controller', 7],
          [`#${main}:ingots/electrum`, [0, 2, 6, 8]]
     ]).vanilla()
})