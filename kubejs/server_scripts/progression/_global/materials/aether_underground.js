...
itemTags((event, funcs) => {
     funcs.add(tags.holystone, holystone)
     funcs.add(`${main}:dusts/gravitite`, 'aether_redux:gravitite_ingot')
})
...
commonTags((event, funcs) => {
     event.add(`${main}:ores`, ['aether:ambrosium_ore', 'ancient_aether:aether_quartz_ore', 'aether:zanite_ore', 'aether_redux:veridium_ore', 'aether:gravitite_ore', 'ancient_aether:valkyrum_ore', 'deep_aether:skyjade_ore', 'aether_genesis:continuum_ore'])
})