recipes((event, funcs) => {
     funcs.replaceWithInsert(`ae2:controller`, [
          ...
          [`#${main}:ingots/enderium`, [7, 17]], 
          [`ae2:smooth_sky_stone_block`, [11, 13]], 
          [`ae2:fluix_crystal`, [6, 8, 16, 18]], 
          [`#${main}:ingots/copper`, [1, 3, 5, 9, 15, 19, 21, 23]], 
          [`#${main}:ingots/redstone_alloy`, [2, 10, 14, 22]], 
     ...
     funcs.replaceWithInsert(`ae2:chest`, [
          ...
          [`#${main}:ingots/redstone_alloy`, [3, 5]],
          [`#ae2:glass_cable`, 1],
          [`#${main}:ingots/enderium`, 7],
          [`#${main}:ingots/iron`, [0, 2, 6, 8]]
     ]).vanilla()
     ...
     funcs.replaceWithInsert(`ae2:drive`, [
          ...
          [`#${main}:ingots/enderium`, [3, 5]],
          [`#${main}:ingots/conductive_alloy`, [0, 2, 6, 8]]
     ]).vanilla()
})
